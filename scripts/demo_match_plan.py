...
profile = ProfessionalProfile(
    ...
    experience=[
        ExperienceItem(
            title="Senior ML Engineer", company="StreamCo",
            start_date="Jan 2022", end_date="Present", location="Remote",
            bullets=[
        ...
        ExperienceItem(
            title="ML Engineer", company="HealthCo",
...
agent = MatchPlannerAgent(llm=OpenAILLMClient())
plan = agent.plan(jd, profile)
